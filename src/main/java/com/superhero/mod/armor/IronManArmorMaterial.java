...
public class IronManArmorMaterial implements ArmorMaterial {
    ...
    public static final IronManArmorMaterial INSTANCE = new IronManArmorMaterial();
    ...
    public List<Layer> getLayers() {
        return List.of(new Layer(net.minecraft.util.Identifier.of("superheromod", "iron_man")));
    }
}
